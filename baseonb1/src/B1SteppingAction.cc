...
//  G4cout << "From_steppingaction" << ' ' << particleName << ' ' << kineticEfromStepping/(CLHEP::MeV) << ' ' << "MeV" << ' ' << G4BestUnit(kinEnergyfromTrack, "Energy") << ' ' << momentumX/(CLHEP::MeV) << ' ' << momentumY/(CLHEP::MeV) << ' ' << momentumZ/(CLHEP::MeV) << ' ' << "MeV" << ' ' << momentumZ/(MeV) << ' ' << G4BestUnit(momentumZ, "Energy") << ' ' << G4endl;

//  G4cout << "From_steppingaction" << ' ' << particleName << ' ' << kineticEfromStepping/(CLHEP::MeV) << ' ' << "MeV" << ' ' << G4BestUnit(kinEnergyfromTrack, "Energy") << ' ' << momentumdirectionX << ' ' << momentumdirectionY << ' ' << momentumdirectionZ << ' ' << VertexPositionZ/(cm) << ' ' << "cm" << ' ' << parentID << ' ' << G4endl;
